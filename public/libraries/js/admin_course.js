$("#course_uni_id").change(function(){
    var uni = $("#course_uni_id").val();
    var fac = $("#course_fac_id");
    var options;
...
$("#course_fac_id").change(function(){
    let uni = $("#course_uni_id").val();
    let fac = $("#course_fac_id").val();
