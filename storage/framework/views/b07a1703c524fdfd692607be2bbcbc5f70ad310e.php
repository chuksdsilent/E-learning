            ...
            <div class="table">
                <table class="table table-striped hover" id="videos">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($i++); ?></td>
                            <td> <a href="<?php echo e(url('admin/video/'. $item->vid_id)); ?>"><?php echo e($item->title); ?></a> </td>
                            <td><?php echo e(\App\VideoViewsLikes::where('vid_id', $item->vid_id)->where('views', 1)->count()); ?>

                            </td>
                            <td><?php echo e(\App\VideoViewsLikes::where('vid_id', $item->vid_id)->where('thumbs_up', 1)->count()); ?>

                            </td>
                            <td><?php echo e(\App\VideoViewsLikes::where('vid_id', $item->vid_id)->where('thumbs_down', 1)->count()); ?>
...
<?php echo $__env->make('admin.partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\felken\resources\views/admin/videos.blade.php ENDPATH**/ ?>