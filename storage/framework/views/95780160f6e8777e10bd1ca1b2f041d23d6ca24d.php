...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('libraries/toastify.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/css/admin_desktop.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('libraries/datatables/datatables/css/jquery.dataTables.min.css')); ?>"
        rel="stylesheet">
...
<body>
        ...
        <div class="row no-padding no-magin">
            <div class="col-md-12 no-padding no-magin">
                <div class="navbar desktop navbar-expand-lg navbar-light">
                    <div class="container">
                        <a class="navbar-brand" href="<?php echo e(url('instructor/dashboard')); ?>">E-Learning</a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                    ...
                                    <span class="profile-pics">
                                        <?php if( \App\Instructors::where('email',
                                        Auth::user()->email)->value('profile_pics') != ""): ?>
                                        <img src=" <?php echo e(asset( \App\Instructors::where('email', Auth::user()->email)->value('profile_pics') )); ?> "
                                            class="img-fluid mr-2" alt="" id="pics"
                                            style="width: 35px; height: 35px; border-radius: 50%; object-fit: cover;">
                                        <?php else: ?>
                                        <img src="<?php echo e(asset('images/profile_avater.png')); ?>" class="img-fluid mr-2" alt="">
                                        <?php endif; ?>
                                        <?php echo e(\App\Instructors::where('email', Auth::user()->email)->value('first_name')); ?>

                                        <?php echo e(\App\Instructors::where('email', Auth::user()->email)->value('last_name')); ?>

                                    </span>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo e(route('instructor.change-password')); ?>">Change
                                        Password</a>
                                    <a class="dropdown-item" href="<?php echo e(route('instructor.profile')); ?>">Profile</a>
                ...
                <nav class="sidepanel fixed-top" style="z-index: 10000;">
                    ...
                    <div class="user mt-5 d-flex justify-content-center" style="margin: 0 auto; text-align: center; ">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-center">
                                <img src="
                                    <?php echo e(asset( \App\Instructors::where('email', Auth::user()->email)->value('profile_pics') )); ?> "
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <img src="<?php echo e(asset('images/profile_avater.png')); ?>" class="img-fluid " alt=""
                    ...
                    <div class="side-menu mt-3 pt-5">
                        <div class="mobile-side-content">
                            ...
                            <a href="<?php echo e(url("instructor/dashboard")); ?>"> <i class="fas fa-tachometer-alt"></i>
                                Dasboard</a>

                            <a href="<?php echo e(route('instructor.upload.video')); ?>"> <i class="fas fa-video"></i>Upload Video</a>

                            <a href="<?php echo e(url("instructor/videos")); ?>"> <i class="fa fa-video"></i> Videos</a>


                            <a href="<?php echo e(route('instructor.profile')); ?>"> <i class="fa fa-user"></i>
                                Profile</a>

                            <a href="<?php echo e(route('instructor.change-password')); ?>"> <i class="fas fa-lock"></i>Change
                                Password</a>
                            <a href="<?php echo e(route('instructor.logout')); ?>"> <i class="fas fa-power-off"></i>Logout</a>
                        </div>
            ...
            <div class="col-md-3 no-padding no-margin" style="max-width: 20%;">
                <div class="side-bar">
                    <div class="side-content">
                        <a href="<?php echo e(url("instructor/dashboard")); ?>"> <i class="fa fa-tachometer-alt"></i> Dashboard</a>
                        <a href="<?php echo e(url("instructor/videos")); ?>"> <i class="fa fa-video"></i> Videos</a>
                        <a href="<?php echo e(route('instructor.upload.video')); ?>"> <i class="fas fa-video"></i>Upload Video</a>
    ...
    <script src="<?php echo e(asset('libraries/datatables/datatables/js/jquery.dataTables.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\felken\resources\views/instructor/partials/layout.blade.php ENDPATH**/ ?>