        ...
        <div class="col-md-2 no-padding no-magin">
            <div class="side-bar">
                <div class="side-content">
                    <a href="<?php echo e(route('admin.dashboard')); ?>"> <i class="fas fa-tachometer-alt"></i> Dashboard</a>
                    <a href="<?php echo e(route('admin.payments')); ?>"> <i class="fas fa-plus-circle"></i> Payments</a>
                    <a href="<?php echo e(route('admin.create-school')); ?>"> <i class="fas fa-plus-circle"></i> Create</a>
                    <a href="<?php echo e(route('admin.institutions')); ?>"> <i class="fas fa-school"></i> Institutions</a>
                    <a href="<?php echo e(route('admin.instructors')); ?>"> <i class="fas fa-users"></i> Instructors</a>
                    <a href="<?php echo e(route('admin.subjects')); ?>"> <i class="fas fa-book"></i> Subjects</a>
                    <a href="<?php echo e(route('admin.students')); ?>"> <i class="fas fa-user-friends"></i> Students</a>
                    <a href="<?php echo e(route('admin.sec.students')); ?>"> <i class="fas fa-user-friends"></i> Sec. Students</a>
                    <a href="<?php echo e(route('admin.other-students')); ?>"> <i class="fas fa-user-friends"></i> other Inst. Students</a>
                    <a href="<?php echo e(route('admin.videos')); ?>"> <i class="fas fa-video"></i> Uni. Videos</a>
                    <a href="<?php echo e(route('admin.sec-videos')); ?>"> <i class="fas fa-video"></i> Sec. Sch. Videos</a>
                    <a href="<?php echo e(route('admin.other.videos')); ?>"> <i class="fas fa-video"></i> Other inst. Videos</a>
                </div>
            </div>
        </div>
                    ...
                    <ul class="navbar-nav mr-3">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<?php echo e(route('admin.change-password')); ?>">Change
                                    Password</a>
...
<script src="<?php echo e(asset('libraries/js/notice.js')); ?>"></script>
<script src="<?php echo e(asset('libraries/js/admin_course.js')); ?>"></script>
<script src="<?php echo e(asset('libraries/js/topic.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\felken\resources\views/admin/partials/layout.blade.php ENDPATH**/ ?>