    ...
    <div class=" py-5 px-3 mt-5">
        <div>
            ...
            <div id="display" class="d-flex justify-content-center">
                <?php $options = Auth::user()->institution; ?>
                    <?php if($options == "sec"): ?>
                        ...
                        <?php if( \App\SecStudents::where('email', Auth::user()->email)->value('profile_pics') != ""): ?>
                    ...
                    <?php elseif($options == "uni"): ?>
                        <?php if( \App\Students::where('email', Auth::user()->email)->value('profile_pics') != ""): ?>
                    ...
                    <?php elseif($options == "others"): ?>
                        <?php if( \App\OtherInstitutionStudents::where('email', Auth::user()->email)->value('profile_pics') != ""): ?>
            ...
            <div class="d-flex justify-content-center">
                <form action="">
                    <input type="hidden" name="" id="user-email" value="<?php echo e(Auth::user()->email); ?>">
...
<?php /**PATH C:\xampp\htdocs\felken\resources\views/student/student_inner_profile.blade.php ENDPATH**/ ?>