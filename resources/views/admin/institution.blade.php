                ...
                <tbody>
                    ...
                    @foreach ($institutions as $item)
                        <tr>
                            <th scope="row">{{ $i++ }}</th>
                            <td>
                                <a href="{{url('admin/institution/courses/'. $item->institution_id)}}">{{$item->institution_name}}</a>
                            </td>
                            <td>
                                {{\App\OtherInstitutionCourses::where('institution_id', $item->institution_id)->count()}}
                            <td>
                                ...
                                <div class="modal fade" id="edit-{{$item->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <form action="{{url('admin/institution/update/'. $item->institution_id)}}" method="post">
                                        @csrf
                                        @method('PATCH')
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$item->institution_name}}" name="name"
