...
<style>
    .learn-with {
        background-image: url("{{ asset('images/bannersbg.png')}} ");
    ...
    @media screen and (max-width: 700px) {
        .learn-with {
            background-image: url("{{ asset('images/mobile_captivating.png')}} ");
            background-repeat: no-repeat;
            height: 300px;
        }
    }
            ...
            <div class=" d-flex justify-content-center">
                <div class="master">
                    ...
                    <div class="d-block  d-flex justify-content-end mr-3 ml-3">
                        <a href="{{url('signup/form')}}" class="btn btn-primary join-us" data-aos="fade-right">
                            Register
                        </a>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12 col-12 no-margin no-padding">
            <div class="learn-with">
                ...
                <a href="{{url('signup/form')}} " style="width: 150px;" class="btn btn-primary">
                    Join Us
                </a>
            </div>
        </div>
